...
Simple task tracker for small business teams: create tasks with due dates, priority, assignee, and notes; mark completed; see overdue items at a glance.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "314140109+oaademo1-ui@users.noreply.github.com"
  git config user.name "oaademo1-ui"
  ```
